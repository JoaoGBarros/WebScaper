...
if __name__ == '__main__':
    ...
    navegador.implicitly_wait(2)  # Espera 2 segundos antes de comecar a coleta de dados para dar tempo da pagina
    ...
    while existe_proxima:
        ...
        for a in soup.find_all('div', attrs={'class': 'andes-card andes-card--flat andes-card--default ui-search-result ui-search-result--core andes-card--padding-default andes-card--animated'}):
            ...
            if produtoCerto(nome.text, produto):
                ...
                link = a.find('a', attrs={'class': 'ui-search-result__content ui-search-link'})
